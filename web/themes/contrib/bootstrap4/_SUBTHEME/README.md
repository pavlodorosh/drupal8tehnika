...
* Update import path in `SUBTHEME/scss/style.scss` to Bootstrap 4 theme path `@import "[DOCROOT]/themes/contrib/boostrap4/scss/style";`, eg replace [DOCROOT] with path to your docroot.
